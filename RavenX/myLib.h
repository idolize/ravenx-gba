...
#define OFFSET(r,c,maxcols) ((r)*(maxcols)+(c)) // default val of maxcols is 240
...
#define KEY_PRESSED(key) (((lastButtons & (key)) != (key)) && KEY_DOWN_NOW(key))
...
/*-------------------------------------------------------------
 *
 *       Size                   Size8   Size16  Size32  Size64
 *   Shape
